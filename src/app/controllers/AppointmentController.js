...
class AppointmentController {
  ...
  async store(req, res) {
    ...
    await Notification.create({
      ...
      user: provider_id, // quem vai receber a notificacao
    });
  ...
  async delete(req, res) {
    ...
    // Só o usuario logado pode cancelar o appointment dele
    ...
    const dateWithSub = subHours(appointment.date, 2); // remove 2 horas do agendamento
